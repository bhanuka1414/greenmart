    ...
    <div class="container">
        ...
        <div class="col-md-3 hidden-xs hidden-sm scrollbar" id="style-2" style="height: 500px; border-left: 10px solid #C0392B; overflow-y: scroll;">
            <ul class="nav" style="border-right: 10px solid #C0392B;">
                <li style="border-top: 1px solid #C0392B; border-bottom: 1px solid #C0392B;"><a href="#">beer</a></li>
                <li style="border-top: 1px solid #C0392B; border-bottom: 1px solid #C0392B;"><a href="#">sprits</a></li>
                <li style="border-top: 1px solid #C0392B; border-bottom: 1px solid #C0392B;"><a href="#">wines</a></li>
                <li style="border-top: 1px solid #C0392B; border-bottom: 1px solid #C0392B;"><a href="#">foreing</a></li>
                <li style="border-top: 1px solid #C0392B; border-bottom: 1px solid #C0392B;"><a href="#">locals</a></li>
            </ul>
        </div>
        <div class="col-md-9" style="min-height: 500px;">
            
            <center><h3>catrgory name</h3></center>
            <hr>
