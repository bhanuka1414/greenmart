...
<body>
    ...
    <div class="container">
        ...
        <div class="col-md-3 hidden-xs hidden-sm scrollbar" id="style-2" style="height: 500px; border-left: 10px solid #C0392B; overflow-y: scroll;">
            ...
            <?php 
                $sql="SELECT sc_name FROM sub_cat WHERE c_id=10";
    ...
    <?php 
        $sql = "SELECT COUNT(*) FROM products WHERE cat=10 AND sub_cat=3";
...
//
$sql="SELECT * FROM products WHERE cat=10 AND sub_cat=3 $limit";
