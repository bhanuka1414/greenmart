...
<?php 
        ...
        if (isset($_GET['reg'])) 
        {
            $sql="select id from user where username='{$_GET['us']}'";
            $res=mysqli_query($con, $sql);
            if(mysqli_num_rows($res)==0)
            {
                $pw_sh=sha1($_GET['pw']);
                $sql="INSERT INTO user (f_name,l_name,email,phone,address,type,username,password,gender) VALUES 
                ('{$_GET['fn']}','{$_GET['ln']}','{$_GET['em']}',{$_GET['pn']},'{$_GET['add']}',4,'{$_GET['us']}',
                '{$pw_sh}','{$_GET['gender']}')";
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-5 col-lg-4" style="min-height: 500px; margin-top: 20px; border: 2px solid #C0392B;">
            <div class="navbar navbar-default navbar-static-top" style="min-height: 100px; background-color: #C0392B;">
