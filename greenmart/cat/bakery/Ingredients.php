...
<body>
    ...
    <div class="container">
        ...
        <div class="col-md-3 hidden-xs hidden-sm scrollbar" id="style-2" style="height: 500px; border-left: 10px solid #C0392B; overflow-y: scroll;">
            ...
            <?php 
                $sql="SELECT sc_name FROM sub_cat WHERE c_id=3";
        ...
        <div class="col-md-9" style="min-height: 500px;">
            ...
            <center><h3>Bakery / Ingredients</h3></center>
            <hr>
    ...
    <?php 
        $sql = "SELECT COUNT(*) FROM products WHERE cat=3 AND sub_cat=5";
...
//
$sql="SELECT * FROM products WHERE cat=3 AND sub_cat=5 $limit";
